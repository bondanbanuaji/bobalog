  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 sm:p-6 md:p-8">
      <div className="relative w-full max-w-[420px]">
        {/* Glow effects */}
        <div className="absolute -top-20 -right-20 w-72 h-72 bg-boba/15 blur-[100px] rounded-full pointer-events-none" />
        <div className="absolute -bottom-20 -left-20 w-72 h-72 bg-taro/15 blur-[100px] rounded-full pointer-events-none" />
        ...
        <div className="relative z-10 glass-card p-6 sm:p-8 rounded-3xl flex flex-col items-center">
          ...
          <p className="mt-6 text-xs text-text-muted text-center">
            Belum punya akun?{' '}
            <Link href="/sign-up" className="text-boba hover:text-boba-light font-medium transition-colors">
              Daftar gratis
            </Link>
          </p>
        </div>
